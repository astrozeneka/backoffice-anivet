      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          >
            ...
            <p>Vivamus suscipit elit at lectus viverra, sed posuere libero laoreet. Maecenas porta laoreet orci, vel vestibulum lorem iaculis at.</p>
...
export default {
  ...
  methods: {
    _next(){
      sessionstorage.setItem("message", "A scientist has been updated successfully")
      sessionstorage.setItem("message-class", "success")
      window.location.href = "scientist-list.html"
    },
    _cancel(){
      window.location.hre = "scientist-list.html"
    }
  }
}
</script>
