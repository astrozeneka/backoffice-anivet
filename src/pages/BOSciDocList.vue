        ...
        <div class="col-md-9">
          ...
          >
            ...
            <template v-slot:default="entity">
              <td>
                <a :href="`sci-doc-edit.html?id=${entity.id}`">{{ entity.reference }}</a></td>
              <td>{{ entity.type }}</td>
